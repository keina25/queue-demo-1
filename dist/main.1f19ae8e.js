...
var divScreen = document.querySelector("#screen"); //大屏幕取这个号码
...
btnCallNumber.onclick = function () {
  ...
  var m = queue.shift(); //const m = queue.shift.call(queue)
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "11207" + '/');
